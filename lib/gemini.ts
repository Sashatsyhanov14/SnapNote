...
8. Можешь добавить краткий вывод, если это уместно.

ЗАПРЕЩЕНО: добавлять пояснения, дополнительные разделы или информацию, которой не было в оригинале.`;

const POLISH_INSTRUCTION = `Ты — корректор текста.
